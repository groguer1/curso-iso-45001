...
(function (global) {
  ...
  var TITLES = [
    'Fundamentos SST y Marco Legal',
    'La norma ISO 45001:2018',
    'Contexto y Liderazgo',
    'Identificación de Peligros y Riesgos',
    'Planificación y Objetivos SST',
    'Soporte y Operación',
    'Investigación de Incidentes',
    'Auditoría Interna y Revisión',
    'Proceso de Certificación SST',
    'Gestión de Contratistas',
    'Casos Prácticos por Sector',
    'Proyecto Final'
  ];

  function file(n) { return 'iso45001-modulo' + n + '.html'; }
  ...
  function buildDocumentPDF(title, contentText, filename) {
    ...
    function drawHeader() {
      ...
      doc.setFontSize(13);
      doc.text('ISOTECNIA · CONSULTOR SST CERTIFICADO', marginX, 30);
    ...
    function drawFooter(pageNum) {
      ...
      doc.setFont('helvetica', 'normal');
      doc.text('Isotecnia — Curso Consultor ISO 45001 · Material de apoyo', marginX, pageH - 28);
